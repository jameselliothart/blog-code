...
namespace csharpstrategy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                case "car":
                    Console.WriteLine(new Trip(new CarStrategy()).GetTravelTime("Point A", "Point B"));
                    break;
                case "bike":
                    Console.WriteLine(new Trip(new BikeStrategy()).GetTravelTime("Point A", "Point B"));
                    break;
                case "bus":
                    Console.WriteLine(new Trip(new BusStrategy()).GetTravelTime("Point A", "Point B"));
                    break;
                default:
